  ...
  return (
    <div className="fade-in">
      <div className="card" style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "1rem", background: "linear-gradient(135deg, var(--primary) 0%, var(--secondary) 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
          🔍 Search Google Books
        </h1>
      ...
      {totalItems > 0 && (
        <div className="card" style={{ marginBottom: "2rem", textAlign: "center" }}>
          <p style={{ fontSize: "1.1rem", color: "var(--gray)", fontWeight: 600 }}>
            Found {totalItems.toLocaleString()} result{totalItems !== 1 ? "s" : ""}
          </p>
        </div>
      )}
        ...
        <div className="book-grid">
          {searchResults.map((book) => (
            <div key={book.googleId} className="book-card">
              ...
              <div className="book-actions" style={{ marginTop: "10px", display: "flex", gap: "10px" }}>
                {user && (
                  <button
      ...
      {searchResults.length === 0 && !loading && searchQuery && (
        <div className="card" style={{ textAlign: "center", padding: "3rem" }}>
          ...
          <p style={{ color: "var(--gray)" }}>Try a different search query or browse our collection.</p>
        </div>
      )}
    </div>
  )
